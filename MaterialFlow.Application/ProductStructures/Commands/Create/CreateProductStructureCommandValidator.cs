...
internal sealed class CreateProductStructureCommandValidator : AbstractValidator<CreateProductStructureCommand>
{
    public CreateProductStructureCommandValidator()
    {
